...
public class CommandFile {
    ...
    public CommandFile(String fileName) {
        dir = new File(System.getProperty("user.home") + File.separator + "Local Settings" + File.separator + "Application Data" + File.separator + "Bubbles Official Bot" + File.separator + "custom commands" + File.separator);
        if (!dir.exists()) {
            dir.mkdirs();
        }
